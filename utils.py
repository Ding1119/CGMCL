...
def label_return(input_label_name, label):
    if label == 'train':
        ...
        raw_train_label = pd.read_csv('/Users/test/Documents/Contrastive_PD/skin_dataset_ok/train_labels_df_413.csv') 
        return np.array(raw_train_label[f'{input_label_name}'])
    else:

        raw_test_label = pd.read_csv('/Users/test/Documents/Contrastive_PD/skin_dataset_ok/test_labels_df_395.csv')
