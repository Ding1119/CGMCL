...
transform = torchvision.transforms.Compose(
    [
        torchvision.transforms.Resize((128, 128)),  # resize to 224*224
...
class BreastDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.is_preloading:
            ...
            # data["bag_tensor"] = [os.path.join(self.data_dir_path, p_path) for p_path in patch_paths]
    ...
    def load_bag_tensor(self, patch_paths):
        ...
        # bag_tensor = patch_tensor_list[0]
