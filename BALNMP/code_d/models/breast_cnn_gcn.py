...
#         import pdb;pdb.set_trace()
        ...
        # import pdb;pdb.set_trace()
        # x_gat_f = self.gat_f(x_f, adjacency_f)
        ...
        attended_gcn_f = x_gat_f * w_att_f
        attended_gcn_img = x_gat_img * w_att_img
        x_f_att = torch.cat((x_f_fusion, attended_gcn_f), 1) # torch.Size([300, 17])
        x_img_att = torch.cat((x_img, attended_gcn_img), 1) # torch.Size([300, 1029])
